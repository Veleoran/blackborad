...
function Header() {
  ...
  const handleShowHiddenArticles = () => {
    // Dispatch l'action pour réinitialiser la liste des articles cachés
    dispatch({ type: 'SHOW_HIDDEN_ARTICLES' });
  };
  ...
  return (
    <header className={styles.header}>
      <div className={styles.logoContainer}>
        ...
        {userSection}
        <FontAwesomeIcon onClick={handleShowHiddenArticles} className={styles.eyeIcon} icon={faEye} />
      </div>
